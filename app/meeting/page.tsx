...
const sessionFocus = [
  "가까운 사이에서도 우리는 상대의 마음을 안다고 쉽게 단정합니다. 나와 상대의 마음을 헤아리는 태도를 통해 관계를 회복하는 방법을 담은 책입니다.",
  "철학자와 청년의 대화로 아들러 심리학을 풀어낸 책입니다. 타인의 기대와 인정에 얽매이지 않고 자신의 삶을 선택할 용기를 이야기합니다.",
  "비난과 판단 대신 자신의 느낌과 욕구를 표현하고, 상대의 마음을 듣는 대화법을 소개합니다. 관찰·느낌·욕구·부탁이라는 네 요소를 통해 갈등 속에서도 서로를 이해할 길을 찾습니다.",
  "사랑을 배우고 연습해야 하는 능력으로 바라보는 책입니다. 누군가를 사랑한다는 것이 무엇인지, 사랑에는 어떤 태도와 노력이 필요한지 탐구합니다."
] as const;
